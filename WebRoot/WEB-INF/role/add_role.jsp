...
<html xmlns="http://www.w3.org/1999/xhtml">
				      		...
				      		if(data) {
				      			...
				      			setTimeout(function(){
				   				...
				   				swal({
				       				title:'Oh, My God !',
				       				html:true,
				       				text:'<span class="swal_error">添加角色失败,请稍后重试!</span>',
				       				type:'error',
				       				timer:2000
				          		});
				      		}
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">            
            <form action="addRole.do" method="post" class="main_form" id="addRole">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="name" id="name"/>
